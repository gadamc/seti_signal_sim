...
public class DataSimulator 
{
  ...
  public static void main (String[] args) throws Exception
		...
		String ampModType, double ampModPeriod, double ampModDuty, OutputStream OS, String signalClass, long seed) throws IOException
	{
		...
		int spectrogramSize = 6144;
		System.out.format("before loop. cosPhi: %.8f, sinPhi: %.8f.%n", cosPhi, sinPhi);
		...
		for (int i = 0; i < len; ++i)
		{
			...
			// if (i % spectrogramSize == 0 || i % spectrogramSize == 1) {
			// 	System.out.format("i: %d, line: %d, X: %d, Y: %d, cosPhi: %.8f, sinPhi: %.8f.%n", i, i/spectrogramSize, X, Y, cosPhi, sinPhi);
			// }
